...
(function() {
    ...
    function eb(g) {
        if (S.fSDec) g[W("`eeDwdouMhrudods")](W("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
            S._fTWm && S._fTWm(g)
        })
    }
    ...
    function gb(g) {
        if (g._menuButton) g.exportEnabled ? (ga(g._menuButton, {
            backgroundColor: g.toolbar.itemBackgroundColor,
            color: g.toolbar.fontColor
        }), Ka(g._menuButton), g._menuButton.title = g._cultureInfo.menuText) : ua(g._menuButton);
            ...
            J(g._menuButton, "touchstart", function(g) {
                l = !0
            ...
            J(g._menuButton, "mouseover", function() {
                l || (ga(g._menuButton, {
                    backgroundColor: g.toolbar.itemBackgroundColorOnHover,
                    color: g.toolbar.fontColorOnHover
                }), 0 >= navigator.userAgent.search("MSIE") && ga(g._menuButton.childNodes[0], {
        ...
        if (g.exportEnabled && g._dropdownMenu) {
            ...
            v.innerHTML = g._cultureInfo.saveJPGText, v.style.backgroundColor = g.toolbar.itemBackgroundColor, v.style.color = g.toolbar.fontColor, g._dropdownMenu.appendChild(v), J(v, "touchstart", function(g) {
                l = !0
            }, g.allDOMEventHandlers), J(v, "mouseover", function() {
                l || (this.style.backgroundColor = g.toolbar.itemBackgroundColorOnHover, this.style.color = g.toolbar.fontColorOnHover)
            }, g.allDOMEventHandlers, !0), J(v, "mouseout", function() {
                ...
                ua(g._dropdownMenu)
            }, g.allDOMEventHandlers, !0), v = document.createElement("div"), v.style.cssText = "padding: 12px 8px 12px 8px", v.innerHTML = g._cultureInfo.savePNGText, v.style.backgroundColor = g.toolbar.itemBackgroundColor, v.style.color = g.toolbar.fontColor, g._dropdownMenu.appendChild(v), J(v, "touchstart", function(g) {
                l = !0
            }, g.allDOMEventHandlers), J(v, "mouseover", function() {
    ...
    function hb(g) {
        if (!ib) {
            ...
            "undefined" === typeof pa.Chart.creditHref ?
                (g.creditHref = W("iuuqr;..b`ow`rkr/bnl."), g.creditText = W("B`ow`rKR/bnl")) : (l = g.updateOption("creditText"), v = g.updateOption("creditHref"));
    ...
    function va(g, l, v) {
        l.getAttribute("state") || (l.style.backgroundColor = g.toolbar.itemBackgroundColor, l.style.color = g.toolbar.fontColor, l.style.border = "none", ga(l, {
        ...
        l.getAttribute("state") !==
            v && (l.setAttribute("state", v), l.setAttribute("type", "button"), ga(l, {
                padding: "5px 12px",
                cursor: "pointer",
                "float": "left",
                width: "40px",
                ...
                lineHeight: "0"
            }), l.setAttribute("title", g._cultureInfo[v + "Text"]), l.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + jb[v].image + "' alt='" + g._cultureInfo[v + "Text"] + "' />")
    }
    ...
    var fb = function() {
        ...
        ea = function(g, l, v) {
            ...
            for (S = F = K = J = N = 0; 0 < M.length;)
                ...
                "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function(a) {
                return X(U, a.length)
            }));
            y = "";
    ...
    U.prototype.addEventListener = function(g, l, s) {
        g && l && (this._eventListeners[g] =
            this._eventListeners[g] || [], this._eventListeners[g].push({
                context: s || this,
                eventHandler: l
            }))
    };
    ...
    y = Oa.Chart = function() {
        ...
        function l(a, d, b) {
            d = d || {};
            s(b) ? (this.predefinedThemes = ab, this.optionsName =
        ...
        function v(a, d) {
            for (var b = [], c, e = 0; e < a.length; e++)
                if (0 == e) b.push(a[0]);
                    ...
                    c = Math.abs((a[p].x - a[f].x) / (0 === a[p].x - a[t].x ? 0.01 : a[p].x - a[t].x)) * (d - 1) /
                        2 + 1;
                    var B = (a[p].x - a[f].x) / c;
                    c = (a[p].y - a[f].y) / c;
                    b[b.length] = a[t].x > a[f].x && 0 < B || a[t].x < a[f].x && 0 > B ? {
                        x: a[t].x + B / 3,
                        y: a[t].y + c / 3
                    } : {
                        x: a[t].x,
        ...
        function y(a, d, b, c, e, f, p, t, B, k) {
            ...
            a.beginPath();
            B && 0 < t.thickness ? (a.moveTo(c - p.thickness / 2, Math.round((b + e) / 2) - n), a.lineTo(d + p.thickness / 2, Math.round((b + e) / 2) - n)) : 0 < t.thickness && (a.moveTo(Math.round((d +
                c) / 2) - n, b + p.thickness / 2), a.lineTo(Math.round((d + c) / 2) - n, e - p.thickness / 2));
            a.stroke();
        ...
        function E(a, d, b, c, e, f) {
            ...
            this.isOptionsInArray = !0;
            "axisX" === e ? ("left" === f || "bottom" === f ? (this.optionsName = "axisX", s(this.chart.sessionVariables.axisX[c]) && (this.chart.sessionVariables.axisX[c] = {}), this.sessionVariables = this.chart.sessionVariables.axisX[c]) : (this.optionsName = "axisX2", s(this.chart.sessionVariables.axisX2[c]) && (this.chart.sessionVariables.axisX2[c] = {}), this.sessionVariables = this.chart.sessionVariables.axisX2[c]), this.options.interval || (this.intervalType = null)) : "left" ===
                f || "bottom" === f ? (this.optionsName = "axisY", s(this.chart.sessionVariables.axisY[c]) && (this.chart.sessionVariables.axisY[c] = {}), this.sessionVariables = this.chart.sessionVariables.axisY[c]) : (this.optionsName = "axisY2", s(this.chart.sessionVariables.axisY2[c]) && (this.chart.sessionVariables.axisY2[c] = {}), this.sessionVariables = this.chart.sessionVariables.axisY2[c]);
            ...
            if (this.options.data) {
                for (var b = 0; b < this.options.data.length; b++)
                    if (a++, !this.options.data[b].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[b].type)) {
                        ...
                        "error" === c.type && (c.linkedDataSeriesIndex = s(this.options.data[b].linkedDataSeriesIndex) ? b - 1 : this.options.data[b].linkedDataSeriesIndex, 0 > c.linkedDataSeriesIndex || c.linkedDataSeriesIndex >=
                            this.options.data.length || "number" !== typeof c.linkedDataSeriesIndex || "error" === this.options.data[c.linkedDataSeriesIndex].type) && (c.linkedDataSeriesIndex = null);
                        null === c.name && (c.name = "DataSeries " + a);
                        null === c.color ? 1 < this.options.data.length ? (c._colorSet = [this.selectedColorSet[c.index % this.selectedColorSet.length]], c.color = this.selectedColorSet[c.index % this.selectedColorSet.length]) : c._colorSet = "line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" ===
                            c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type || "candlestick" === c.type || "ohlc" === c.type || "waterfall" === c.type || "boxAndWhisker" === c.type ? [this.selectedColorSet[0]] : this.selectedColorSet : c._colorSet = [c.color];
                        ...
                        "bubble" !== c.type && "scatter" !==
                            c.type || !c.dataPoints || (c.dataPoints.some ? c.dataPoints.some(function(a) {
                                return a.x
                            }) && c.dataPoints.sort(g) : c.dataPoints.sort(g));
                        this.data.push(c);
                        var e = c.axisPlacement,
                            d = d || e,
                            f;
                        "normal" === e ? "xySwapped" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with bar chart' : "none" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with pie chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement = "normal") : "xySwapped" === e ? "normal" === this.plotInfo.axisPlacement ?
                            f = 'You cannot combine "' + c.type + '" with line, area, column or pie chart' : "none" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with pie chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement = "xySwapped") : "none" === e ? "normal" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with line, area, column or bar chart' : "xySwapped" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with bar chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement =
                                "none") : null === e && "none" === this.plotInfo.axisPlacement && (f = 'You cannot combine "' + c.type + '" with pie chart');
                        if (f && window.console) {
                    ...
                    "error" === this.data[b].type && (this.data[b].axisPlacement = this.plotInfo.axisPlacement = d || "normal", this.data[b]._linkedSeries = null === this.data[b].linkedDataSeriesIndex ? null :
        ...
        l.prototype.setLayout = function() {
                    ...
                    if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var b = 0; b < this.options.axisY.length; b++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new E(this, "axisY", this.options.axisY[b], b, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[b] = new E(this, "axisY", this.options.axisY[b], b, "axisY",
                                    "bottom"));
                    ...
                    if ("secondary" === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (b = 0; b < this.options.axisY2.length; b++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new E(this, "axisY2", this.options.axisY2[b], b, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new E(this,
                                    "axisY2", this.options.axisY2[b], b, "axisY", "top"));
                            ...
                            this._axes.push(this.axisY2[0] = new E(this, "axisY2", this.options.axisY2, 0, "axisY", "top"))), this.data[d].axisY = this.axisY2[0], this.axisY2[0].dataSeries.push(this.data[d]);
                    if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (b = 0; b < this.options.axisX.length; b++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new E(this, "axisX", this.options.axisX[b], b, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement &&
                                    this._axes.push(this.axisX[b] = new E(this, "axisX", this.options.axisX[b], b, "axisX", "left"));
                            ...
                            "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new E(this, "axisX", this.options.axisX, 0, "axisX", "left"))), this.data[d].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[d]);
                    if ("secondary" === this.data[d].axisXType)
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (b = 0; b < this.options.axisX2.length; b++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new E(this, "axisX2", this.options.axisX2[b], b, "axisX", "top")) : "xySwapped" ===
                                    this.plotInfo.axisPlacement && this._axes.push(this.axisX2[b] = new E(this, "axisX2", this.options.axisX2[b], b, "axisX", "right"));
            ...
            if (0 < this._axes.length && this.options.zoomEnabled && (this.zoomEnabled || this.panEnabled))
                for (d = 0; d < this._axes.length; d++)
                    if (null !== this._axes[d].viewportMinimum || null !== this._axes[d].viewportMaximum) {
                        b = !0;
                        break
                    } b ? (Ka(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, this._zoomButton.style.borderRight =
            ...
            if (this.options.subtitles)
                for (d = 0; d < this.options.subtitles.length; d++) b = new Ha(this, this.options.subtitles[d], d), this.subtitles.push(b), b.dockInsidePlotArea ? a.push(b) : b.setLayout();
        ...
        l.prototype.renderElements = function() {
            ...
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" ===
                this.plotInfo.axisPlacement) E.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement);
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], p = 0; p < f.plotUnits.length; p++) {
                    var t = f.plotUnits[p],
                        B = null;
                    t.targetCanvas = null;
                    this.animatedRender && (t.targetCanvas =
                        ta(this.width, this.height), t.targetCanvasCtx = t.targetCanvas.getContext("2d"), e = t.targetCanvasCtx.miterLimit, t.targetCanvasCtx.miterLimit = 3);
            ...
            var m = this;
            if (0 < b.length) m.disableToolTip = !0, m._animator.animate(200,
                m.animationDuration,
                function(a) {
                    m.ctx.clearRect(0, 0, m.width, m.height);
                    m.ctx.drawImage(c, 0, 0, Math.floor(m.width * ka), Math.floor(m.height * ka), 0, 0, m.width, m.height);
                    for (var e = 0; e < b.length; e++) B = b[e], 1 > a && "undefined" !== typeof B.startTimePercent ? a >= B.startTimePercent && B.animationCallback(B.easingFunction(a - B.startTimePercent, 0, 1, 1 - B.startTimePercent), B) : B.animationCallback(B.easingFunction(a, 0, 1, 1), B);
                ...
                function() {
                    ...
                    for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
                        for (var e =
                                m.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) e.plotUnits[d].targetCanvas = null;
                    c = null;
                    m.disableToolTip = !1;
            ...
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a =
                    ...
                    for (p = 0; p < b.plotUnits.length; p++)
                        if (b.plotUnits[p].axisYType === a.axisYType && b.plotUnits[p].axisXType === a.axisXType && b.plotUnits[p].axisYIndex === a.axisYIndex &&
                ...
                for (b = this.plotInfo.plotTypes[d], p = a = 0; p < b.plotUnits.length; p++) b.plotUnits[p].previousDataSeriesCount = a, a += b.plotUnits[p].dataSeriesIndexes.length
        };
        ...
        l.prototype._processData = function() {
            ...
            for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
                for (var d = this.plotInfo.plotTypes[a], b = 0; b < d.plotUnits.length; b++) {
                    var c = d.plotUnits[b];
                    "line" === c.type || "stepLine" === c.type || "spline" === c.type || "column" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "bar" === c.type ||
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var t = this.data[a.dataSeriesIndexes[p]],
                        ...
                        m = !1,
                        n;
                    if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
                    ...
                    if (t.dataPoints[B].x && t.dataPoints[B].x.getTime || "dateTime" ===
                        t.xValueType) f = !0;
                    for (B = 0; B < t.dataPoints.length; B++) {
                        ...
                        if (0 < B) {
                            ...
                            } else r = c - t.dataPoints[B - 1].x, 0 > r &&
                                (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f = !1, p = [], t = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var n = this.data[a.dataSeriesIndexes[m]],
                        ...
                        r = !1,
                        g;
                    if ("normal" === n.axisPlacement ||
                        "xySwapped" === n.axisPlacement) var l = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                        u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ?
                    ...
                    for (q = 0; q < n.dataPoints.length; q++) {
                        ...
                        if (c < l && !h) null !== n.dataPoints[q].y && (g = c);
                            ...
                            c < b.viewPortMin && (b.viewPortMin =
                                c);
                            c > b.viewPortMax && (b.viewPortMax = c);
                            null === n.dataPoints[q].y ? b.viewPortMin === c && g < c && (b.viewPortMin = g) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e, a.yAbsTotals[c] = (a.yAbsTotals[c] ? a.yAbsTotals[c] : 0) + Math.abs(e), 0 <= e ? p[c] ? p[c] += e : (p[c] = e, B = Math.min(e, B)) : t[c] ? t[c] += e : (t[c] = e, k = Math.max(e, k)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, p), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,
                        t)) : (d.dataPointYPositiveSums = p, d.dataPointYNegativeSums = t));
                    n.axisX.valueType = n.xValueType = f ? "dateTime" : "number"
                }
                for (q in p) p.hasOwnProperty(q) && !isNaN(q) && (a = p[q], a < d.min && (d.min = Math.min(a, B)), a > d.max && (d.max = a), q < b.viewPortMin || q > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in t) t.hasOwnProperty(q) && !isNaN(q) && (a = t[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < b.viewPortMin || q > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin =
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f = !1, p = !1, t = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var m = this.data[a.dataSeriesIndexes[k]],
                        ...
                        h = !1,
                        r;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var g = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
                    ...
                    for (n =
                        ...
                        if (c < g && !q) null !== e && (r = c);
                            ...
                            c < b.viewPortMin && (b.viewPortMin = c);
                            c > b.viewPortMax && (b.viewPortMax = c);
                            null === e ? b.viewPortMin === c && r < c && (b.viewPortMin = r) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] :
                ...
                a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && !t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p &&
                    t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !p && t && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = B
            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f, p, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        f < d.min && (d.min = f);
                        p > d.max && (d.max = p);
                        0 < m && (a.axisX.logarithmic ? (r = c / k.dataPoints[m - 1].x, 1 > r && (r = 1 / r), b.minDiff > r && 1 !== r && (b.minDiff = r)) : (r = c - k.dataPoints[m - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[m - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[m - 1].y[0],
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var t = this.data[a.dataSeriesIndexes[p]],
                        ...
                        m = !1,
                        n = c = 0;
                    if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
                    ...
                    for (B = 0; B < t.dataPoints.length; B++) "undefined" !==
                    ...
                    for (B = 0; B < t.dataPoints.length; B++)
                        if ("undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[B].x.getTime ? (f = !0, c = t.dataPoints[B].x.getTime()) : c = t.dataPoints[B].x, e = t.dataPoints[B].y,
                            ...
                            c < b.viewPortMin && (b.viewPortMin = c);
                            c > b.viewPortMax && (b.viewPortMax = c);
                            0 < B && (t.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[B - 1].cumulativeSum), t.dataPointEOs[B -
                                1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[B - 1].cumulativeSum));
        ...
        l.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (c || b)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, k = f.min, p = f.max, m = d.min, n = d.max, f = f._dataRanges,
                            ...
                            if (!(4 > g.dataPoints.length))
                                for (t = 0; t < g.dataPoints.length; t++)
                                    if (c && (q = (p + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = g.dataPoints[t].x.getTime ? g.dataPoints[t].x.getTime() : g.dataPoints[t].x, q = Math.floor((h - k) / q), h < f[q].min && (f[q].min = h), h > f[q].max && (f[q].max = h)), b) {
                                        var l = (n + 1 - m) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                                        if ((h = "waterfall" ===
                                                a.type ? g.dataPointEOs[t].cumulativeSum : g.dataPoints[t].y) && h.length)
            ...
            function b(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var c = a.axisX.dataInfo, b = c.min, d = c.max, f = c._dataRanges,
                            h, k = 0, p = 0; p < a.dataSeriesIndexes.length; p++) {
                        var m = e.data[a.dataSeriesIndexes[p]];
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++) h = (d + 1 - b) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, c = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, h = Math.floor((c - b) / h), c < f[h].min && (f[h].min = c), c > f[h].max && (f[h].max = c)
                    }
            }
            for (var c, e = this, f = !1, p = 0; p < this._axes.length; p++)
                if (this._axes[p].scaleBreaks && this._axes[p].scaleBreaks.autoCalculate && 1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var t = 0; t < 100 / Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) || 10, 10); t++) this._axes[p].dataInfo._dataRanges.push({
                        min: Infinity,
                        max: -Infinity
                    })
                } if (f) {
                for (p = 0; p < this.plotInfo.plotTypes.length; p++)
                    for (f = this.plotInfo.plotTypes[p], t = 0; t < f.plotUnits.length; t++) c = f.plotUnits[t], "line" === c.type || "stepLine" === c.type || "spline" === c.type || "column" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "bar" === c.type || "bubble" ===
                        c.type || "scatter" === c.type || "candlestick" === c.type || "ohlc" === c.type || "rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type || "waterfall" === c.type || "error" === c.type || "boxAndWhisker" === c.type ? d(c) : 0 <= c.type.indexOf("stacked") && b(c);
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        if (this._axes[p].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (n = -1 * q[t], s(n) || (h = Math.floor((n - B) / c), n < m[h].min &&
                                (m[h].min = n), n > m[h].max && (m[h].max = n)));
                        ...
                        if (this._axes[p].scaleBreaks.customBreaks)
                            for (t = 0; t < this._axes[p].scaleBreaks.customBreaks.length; t++)
                                for (c = 0; c < f.length; c++)
                                    if (this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[c].start && f[c].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue ||
                        ...
                        for (t = 0; t < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); t++) c =
                            a(f[t].start, f[t].end, this._axes[p].logarithmic ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min, this._axes[p].logarithmic), this._axes[p].scaleBreaks.autoBreaks.push(new T(this, "autoBreaks", c, t, ++this._eventManager.lastObjectId, this._axes[p].scaleBreaks)), this._axes[p].scaleBreaks._appliedBreaks.push(this._axes[p].scaleBreaks.autoBreaks[this._axes[p].scaleBreaks.autoBreaks.length - 1]);
                        this._axes[p].scaleBreaks._appliedBreaks.sort(function(a,
                            c) {
                            return a.startValue - c.startValue
                        })
                    }
        ...
        l.prototype.getDataPointAtXY = function(a, d, b) {
            b = b || !1;
            for (var c = [], e = this._dataInRenderedOrder.length -
                    1; 0 <= e; e--) {
                var f = null;
            ...
            for (b = 0; b < c.length; b++)
                if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)
                    if (e = la("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= e / 2) {
                        d = !0;
                        break
                    } for (b = 0; b < c.length; b++) d && "line" !== c[b].dataSeries.type && "stepLine" !== c[b].dataSeries.type && "area" !== c[b].dataSeries.type && "stepArea" !== c[b].dataSeries.type ||
        ...
        l.prototype._dispatchRangeEvent = function(a, d) {
            ...
            for (var e = 0; e < c.length; e++)
                if (s(b[c[e]]) && (b[c[e]] = []), "axisY" === c[e])
                    for (var f = 0; f < this.axisY.length; f++) b[c[e]].push({
                ...
                for (f = 0; f <
                    this.axisY2.length; f++) b[c[e]].push({
                    viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum,
                    viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum
                });
            else if ("axisX" === c[e])
                for (f = 0; f < this.axisX.length; f++) b[c[e]].push({
                    viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum,
                    viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum
                });
            else if ("axisX2" === c[e])
                for (f = 0; f < this.axisX2.length; f++) b[c[e]].push({
                    viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum,
                    viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum
                });
        ...
        l.prototype._mouseEventHandler = function(a) {
            ...
            l.capturedEventParam && (c = l.capturedEventParam, "mouseup" === b && (l.capturedEventParam = null, c.chart.overlaidCanvas.releaseCapture ? c.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup",
                c.chart._mouseEventHandler, !1)), c.hasOwnProperty(b) && ("mouseup" !== b || c.chart.overlaidCanvas.releaseCapture ? a.target !== c.chart.overlaidCanvas && w || c[b].call(c.context, d.x, d.y) : a.target !== c.chart.overlaidCanvas && (c.chart.isDrag = !1)));
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
                else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ga && window.console && (window.console.log(b + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which),
                    ...
                    for (var f = 0; f < this._events.length; f++)
                        if (this._events[f].hasOwnProperty(b))
                            if (c = this._events[f], e = c.bounds, d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {
                                ...
                                "mousedown" === b && !0 === c.capture ? (l.capturedEventParam = c, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === b && (c.chart.overlaidCanvas.releaseCapture ?
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled)
                        for (e = f = 0; e < this._axes.length; e++) b = this._axes[e], b.logarithmic ? b.viewportMinimum < b.minimum ? (f = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum * f, b.sessionVariables.newViewportMaximum =
                            ...
                            f, b.sessionVariables.newViewportMaximum = b.viewportMaximum - f, p = !0);
                    ...
                    p && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.stockChart && (this.stockChart.navigator &&
                        this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter || (this.stockChart._rangeEventParameter = {
                    ...
                    }), this.stockChart._rangeEventParameter.type = "rangeChanging", this.stockChart.dispatchEvent("rangeChanging", this.stockChart._rangeEventParameter, this.stockChart)), this.render(), this._dispatchRangeEvent("rangeChanged",
        ...
        l.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(b) && 8 > Math.abs(b) && (this.panEnabled ||
                        this.zoomEnabled)) {
                    this.toolTip.hide();
                    ...
                    for (t = 0; t < this.axisX2.length; t++) this.axisX2[t].crosshair && this.axisX2[t].crosshair.enabled && (this.axisX2[t].crosshair.hide(),
                ...
                if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                    ...
                    }, clearTimeout(p._panTimerId), p._panTimerId = setTimeout(function(c, b, e, f) {
                        return function() {
                    ...
                    this.validateRegion(c, t, e ? a : this.plotArea.x2 -
                        this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
                ...
                if (this.axisX && 0 < this.axisX.length)
                    for (e = 0; e < this.axisX.length; e++) this.axisX[e].crosshair && this.axisX[e].crosshair.enabled && this.axisX[e].renderCrosshair(a,
                        d);
                if (this.axisX2 && 0 < this.axisX2.length)
        ...
        l.prototype._zoomPanToSelectedRegion =
            function(a, d, b, c, e) {
                ...
                b = a.axesRanges;
                if (a.isValid)
                    for (c = 0; c < d.length; c++) e = b[c], d[c].setViewPortRange(e.val1, e.val2), this.syncCharts && "y" != this.zoomType && this.syncCharts(e.val1, e.val2), this.stockChart && (this.stockChart._rangeEventParameter = {
                        stockChart: this.stockChart,
                        source: "chart",
                        index: this.stockChart.charts.indexOf(this),
                        minimum: e.val1,
        ...
        l.prototype.validateRegion = function(a, d, b, c, e) {
            ...
            for (var f = 0 <= this.zoomType.indexOf("x"),
                    p = 0 <= this.zoomType.indexOf("y"), t = !1, B = [], k = [], m = [], n = 0; n < this._axes.length; n++)("axisX" === this._axes[n].type && f || "axisY" === this._axes[n].type && p) && k.push(this._axes[n]);
            for (p = 0; p < k.length; p++) {
                ...
                if (q > h) var r = h,
                    ...
                    q = r;
                if (n.scaleBreaks)
                    for (r = 0; !f && r < n.scaleBreaks._appliedBreaks.length; r++) f = n.scaleBreaks._appliedBreaks[r].startValue <= q && n.scaleBreaks._appliedBreaks[r].endValue >= h;
                if (isFinite(n.dataInfo.minDiff))
                    if (r =
                        n.getApparentDifference(q, h, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && r < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && r < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || h > n.maximum)) B.push(n), m.push({
                        val1: q,
                        val2: h
                    }), t = !0;
                    else if (!e) {
        ...
        l.prototype.preparePlotArea = function() {
            ...
            if ((this.axisX[0] || this.axisX2[0]) &&
                ...
                this.axisY2 && 0 < this.axisY2.length && this.axisY2[0] && (b = this.axisY2[0], a.x1 = d.x1 < d.x2 ?
        ...
        l.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var D = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(C) : m.dataPoint.indexLabel ?
                    this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(C) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
                if (null !== D && "" !== D) {
                    ...
                    } else if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x >
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== A ? (e = b.y1, f = b.y2, 0 < v ? (h = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - c, h < e && (h = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t, y = h + k > m.point.y)) : (h = m.point.y +
                    ...
                    g.y = h;
                    g.render(!0);
                    x && ("inside" !== A && (0 > n.indexOf("bar") && ("error" !== n || !m.axisSwapped) &&
                ...
                for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (x = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                    !C)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (b.stroke(), w && c.stroke()), C = !0;
                                    ...
                                    l || C ? (!l && k.connectNullData ? (b.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(p.x, p.y), n = k.nullDataLineDashType,
                                        b.setLineDash(q)), b.lineTo(x, s), w && c.lineTo(x, s)) : (b.beginPath(), b.moveTo(x, s), w && (c.beginPath(), c.moveTo(x, s))), C = l = !1) : (b.lineTo(x, s), w && c.lineTo(x, s), 0 == u % 500 && (b.stroke(), b.beginPath(), b.moveTo(x, s), w && (c.stroke(), c.beginPath(), c.moveTo(x, s))));
                                    p = {
                                        x: x,
                                        y: s
                                    };
                                    u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) && (b.stroke(), b.beginPath(), b.moveTo(x, s), g = m[u].lineColor || r, b.strokeStyle = g, b.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType, b.setLineDash(N(n, k.lineThickness))) :
        ...
        l.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (x = m[u].getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                                    (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (b.stroke(), w && c.stroke()), C = !0;
                                else {
                                    var D = s;
                                    ...
                                    l || C ? (!l && k.connectNullData ? (b.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(p.x,
                                        p.y), n = k.nullDataLineDashType, b.setLineDash(q)), b.lineTo(x, D), b.lineTo(x, s), w && (c.lineTo(x, D), c.lineTo(x, s))) : (b.beginPath(), b.moveTo(x, s), w && (c.beginPath(), c.moveTo(x, s))), C = l = !1) : (b.lineTo(x, D), w && c.lineTo(x, D), b.lineTo(x, s), w && c.lineTo(x, s), 0 == u % 500 && (b.stroke(), b.beginPath(), b.moveTo(x, s), w && (c.stroke(), c.beginPath(), c.moveTo(x, s))));
                                    p = {
                                        x: x,
                                        y: s
                                    };
                                    u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) && (b.stroke(), b.beginPath(), b.moveTo(x, s), g = m[u].lineColor || r, b.strokeStyle =
                                        g, b.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType, b.setLineDash(N(n, k.lineThickness))) : (n = k.lineDashType, b.setLineDash(h))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, x, s, b), f.push(D), z = P(z), w && f.push({
                                        x: x,
                                        y: s,
                                        ctx: c,
                                        type: D.type,
        ...
        l.prototype.renderSpline = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < m.length)
                        for (x = !1, l = 0; l < m.length; l++)
                            if (u = m[l].getTime ? m[l].x.getTime() : m[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                                if ("number" !== typeof m[l].y) 0 < l && !x && (k.connectNullData ? c.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !m[l - 1].lineDashType)) && (s[s.length -
                                    1].newLineDashArray = q, n = k.nullDataLineDashType) : (d(s), s = [])), x = !0;
                                else {
                                    ...
                                    l < m.length - 1 && (g !== (m[l].lineColor || r) || n !== (m[l].lineDashType || k.lineDashType)) && (g = m[l].lineColor || r, s[s.length - 1].newStrokeStyle = g, c.setLineDash && (m[l].lineDashType ? (n = m[l].lineDashType, s[s.length - 1].newLineDashArray =
                                        N(n, k.lineThickness)) : (n = k.lineDashType, s[s.length - 1].newLineDashArray = h)));
                ...
                V.drawMarkers(p);
                w && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), e.beginPath());
                c.restore();
                c.beginPath();
                return {
                    source: b,
                        ...
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                var s = m - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                                    C = s + h << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[c] = u[k].y + (t[c] ? t[c] :
                                    0), 0 < t[c] && (n = a.axisY.convertValueToPixel(t[c]), D = "undefined" !== typeof f[c] ? f[c] : q, f[c] = n);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[c] = u[k].y + (B[c] ? B[c] : 0), D = a.axisY.convertValueToPixel(B[c]), n = "undefined" !== typeof p[c] ? p[c] : q, p[c] = D;
                                ...
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    direction: 0 > u[k].y === a.axisY.reversed ?
                                        1 : -1,
                                    bounds: {
                                        x1: s,
                                        y1: Math.min(n, D),
                        ...
                        for (var x = 5 < h && l.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                                    ...
                                    D = f[c] ? f[c] : q;
                                    f[c] = n
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[c] = n + ("undefined" !== typeof B[c] ? B[c] : 0), D = a.axisY.convertValueToPixel(B[c]), n = p[c] ? p[c] : q, p[c] = D;
                                    ...
                                    typeof p[c] ? p[c] : 0, D = n + z, n = q + z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), p[c] = z + (D - n);
                                c = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length];
                                ca(b, s, n, C, D, c, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, l.fillOpacity);
                                c = l.dataPointIds[k];
                                this._eventManager.objectMap[c] = {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() :
                                ...
                                var s = n - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                                    C = s + h << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[c] = u[k].y + (t[c] ? t[c] : 0), 0 < t[c] && (D = f[c] ? f[c] : q, f[c] = m = a.axisY.convertValueToPixel(t[c]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[c] = u[k].y + (B[c] ? B[c] : 0), m = p[c] ?
                                    p[c] : q, p[c] = D = a.axisY.convertValueToPixel(B[c]);
                                ...
                                c = P(c);
                                w && ca(this._eventManager.ghostCtx, D, s, m, C, c, 0, null, !1, !1, !1,
                                    !1);
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < u.length) {
                        ...
                        b.strokeStyle = "#4572A7 ";
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                                "number" === typeof u[k].y) {
                                n = a.axisX.convertValueToPixel(c);
                                var A;
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[c] = A + (B[c] ? B[c] : 0), m = p[c] ? p[c] :
                                    q, p[c] = A = a.axisY.convertValueToPixel(B[c]);
        ...
        l.prototype.renderArea = function(a) {
            ...
            function c() {
                D && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = A : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = A), f.lineTo(l, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, w && (p.lineTo(l, C), p.lineTo(D.x, C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(l, u), p.beginPath(), p.moveTo(l, u), D = {
                    x: l,
                    y: u
                })
            }
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var ja = !0; g < r.length; g++)
                            if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s <
                                    a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ja)))
                                if ("number" !== typeof r[g].y) h.connectNullData || (ja || d) || c(), ja = !0;
                                else {
                                    l = a.axisX.convertValueToPixel(s);
                                    u = a.axisY.convertValueToPixel(r[g].y);
                                    d || ja ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || b === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, b = u, l = m.x, u = m.y, c(), f.moveTo(m.x, m.y), l = d, u = b, D = m, b = h.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(l, u), w && p.lineTo(l, u)) :
                                        (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), D = {
                                            x: l,
                                            y: u
                                        }), ja = d = !1) : (f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && c());
                                    m = {
                                        x: l,
                                        y: u
                                    };
                                    g < r.length - 1 && (y !== (r[g].lineColor || v) || b !== (r[g].lineDashType || h.lineDashType)) && (c(), y = r[g].lineColor || v, f.strokeStyle = y, f.setLineDash && (r[g].lineDashType ? (b = r[g].lineDashType, f.setLineDash(N(b, h.lineThickness))) : (b = h.lineDashType, f.setLineDash(aa))));
                                    ...
                                    0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(g, l, u, f), B.push(s), Y = P(Y), w && B.push({
                                        x: l,
                                        y: u,
                                        ctx: p,
                                        type: s.type,
                                    ...
                                    (r[g].indexLabel || h.indexLabel || r[g].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "area",
                                        dataPoint: r[g],
                                        dataSeries: h,
                                        point: {
                ...
                if (0 < b.length) {
                    if (0 < m.lineThickness) {
                        ...
                        for (var d = 0; d < b.length - 3; d += 3)
                            if (c.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), w && e.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), b[d + 3].newStrokeStyle || b[d + 3].newLineDashArray) c.stroke(),
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
                        l = g : 0 > a.axisY.viewportMaximum ? l = f.y1 : 0 < a.axisY.viewportMinimum && (l = g);
                    u = {
                        x: b[0].x,
                        y: b[0].y
                    };
                    ...
                    if (0 < n.length) {
                        ...
                        for (r = !1; q < n.length; q++)
                            if (h = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof n[q].y) 0 < q && !r && (m.connectNullData ? c.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !n[q - 1].lineDashType)) &&
                                    (s[s.length - 1].newLineDashArray = y, z = m.nullDataLineDashType) : (d(), s = [])), r = !0;
                                else {
                                    ...
                                    q < n.length - 1 && (D !== (n[q].lineColor || C) || z !== (n[q].lineDashType || m.lineDashType)) && (D = n[q].lineColor || C, s[s.length - 1].newStrokeStyle = D, c.setLineDash && (n[q].lineDashType ? (z = n[q].lineDashType, s[s.length -
        ...
        l.prototype.renderStepArea = function(a) {
            ...
            function c() {
                D && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = A : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = A), f.lineTo(l, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, w && (p.lineTo(l, C), p.lineTo(D.x,
                    C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(l, u), p.beginPath(), p.moveTo(l, u), D = {
                    x: l,
                    y: u
                })
            }
                    ...
                    if (0 < r.length) {
                        ...
                        for (; g < r.length; g++)
                            if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !b))) {
                                var Y = u;
                                "number" !== typeof r[g].y ? (h.connectNullData || (b || d) || c(), b = !0) : (l = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(r[g].y), d || b ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || Q === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, b = u, l = m.x, u = m.y, c(),
                                    f.moveTo(m.x, m.y), l = d, u = b, D = m, Q = h.nullDataLineDashType, f.setLineDash(aa)), f.lineTo(l, Y), f.lineTo(l, u), w && (p.lineTo(l, Y), p.lineTo(l, u))) : (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), D = {
                                    x: l,
                                    y: u
                                }), b = d = !1) : (f.lineTo(l, Y), w && p.lineTo(l, Y), f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && c()), m = {
                                    x: l,
                                    y: u
                                }, g < r.length - 1 && (y !== (r[g].lineColor || v) || Q !== (r[g].lineDashType || h.lineDashType)) && (c(), y = r[g].lineColor || v, f.strokeStyle = y, f.setLineDash && (r[g].lineDashType ? (Q = r[g].lineDashType, f.setLineDash(N(Q,
                                    h.lineThickness))) : (Q = h.lineDashType, f.setLineDash(E)))), s = h.dataPointIds[g], this._eventManager.objectMap[s] = {
                                    id: s,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: q,
                                    dataPointIndex: g,
                                    x1: l,
                                    y1: u
                                }, 0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < h.markerSize) && (Y = h.getMarkerProperties(g, l, u, f), B.push(Y), s = P(s), w && B.push({
                                    x: l,
                                    y: u,
                                    ctx: p,
                                    type: Y.type,
        ...
        l.prototype.renderStackedArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                fa = null,
                                fa = 0 <= z.dataPointIndexes[f] ? v[z.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData || (Y || x) || d(), Y = !0;
                                    ...
                                    g[f] = l - r;
                                    x || Y ? (!x && z.connectNullData ? (c.setLineDash && (z.options.nullDataLineDashType || A === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = k.pop(), A = k[k.length - 1], d(), c.moveTo(u.x, u.y), k.push(A), k.push(x), A = z.nullDataLineDashType, c.setLineDash(aa)), c.lineTo(h,
                                        r), w && s.lineTo(h, r)) : (c.beginPath(), c.moveTo(h, r), w && (s.beginPath(), s.moveTo(h, r))), Y = x = !1) : (c.lineTo(h, r), w && s.lineTo(h, r), 0 == q % 250 && (d(), c.moveTo(h, r), w && s.moveTo(h, r), k.push({
                                        x: h,
                                        y: l - ma
                                    })));
                                    u = {
                                    ...
                                    q < v.length - 1 && (Q !== (v[q].lineColor || y) || A !== (v[q].lineDashType || z.lineDashType)) && (d(), c.beginPath(), c.moveTo(h, r), k.push({
                                        x: h,
                                        y: l - ma
                                    }), Q = v[q].lineColor || y, c.strokeStyle = Q, c.setLineDash && (v[q].lineDashType ? (A = v[q].lineDashType, c.setLineDash(N(A, z.lineThickness))) : (A = z.lineDashType, c.setLineDash(E))));
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], h, r, c), p.push(ma), f = P(F), w && p.push({
                                        x: h,
                                        y: r,
                                        ctx: s,
                                        type: ma.type,
                ...
                V.drawMarkers(p);
                w && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(t.x1, t.y1, t.width, t.height), s.restore());
                c.restore();
                return {
                    source: b,
                    dest: this.plotArea.ctx,
        ...
        l.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData ||
                                    ...
                                    g[f] = x - r;
                                    s || Y ? (!s && z.connectNullData ? (c.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), c.moveTo(l.x, l.y), k.push(u), k.push(s), u = z.nullDataLineDashType, c.setLineDash(aa)), c.lineTo(h, r), w && A.lineTo(h, r)) : (c.beginPath(), c.moveTo(h, r), w && (A.beginPath(), A.moveTo(h, r))), Y = s = !1) : (c.lineTo(h, r), w && A.lineTo(h, r), 0 == q % 250 && (d(), c.moveTo(h, r), w && A.moveTo(h, r), k.push({
                                        x: h,
                                        y: x - ba
                                    })));
                                    l = {
                                    ...
                                    q < y.length - 1 && (Q !== (y[q].lineColor || E) || u !== (y[q].lineDashType || z.lineDashType)) && (d(), c.beginPath(), c.moveTo(h, r), k.push({
                                        x: h,
                                        y: x -
                                            ba
                                    }), Q = y[q].lineColor || E, c.strokeStyle = Q, c.setLineDash && (y[q].lineDashType ? (u = y[q].lineDashType, c.setLineDash(N(u, z.lineThickness))) : (u = z.lineDashType, c.setLineDash(F))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, h, r, c), t.push(ba), f = P(G),
                                        w && t.push({
                                            x: h,
                                            y: r,
                                            ctx: A,
                ...
                V.drawMarkers(t);
                w && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation =
                        ...
                        for (var n = 0, q = 0, e = 0; e < m.length; e++)
                            if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                ...
                                Math.sqrt((n - f) * (n - f) + (q - p) * (q - p)) < Math.min(h.size, 5) && m.length > Math.min(this.plotArea.width,
                                    this.plotArea.height) || (n = k.dataPointIds[e], this._eventManager.objectMap[n] = {
                                        id: n,
                                        objectType: "dataPoint",
                                        dataSeriesIndex: g,
                                        dataPointIndex: e,
                                        x1: f,
                                        y1: p
                                    }, n = P(n), w && V.drawMarker(h.x, h.y, this._eventManager.ghostCtx, h.type, h.size, n, n, h.borderThickness), (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "scatter",
                                        dataPoint: m[e],
                                        dataSeries: k,
                                        point: {
        ...
        l.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < x.length)
                        for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (x[t].getTime ? h = x[t].x.getTime() : h = x[t].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] &&
                                ...
                                "candlestick" === u.type ? (b.moveTo(g - y, m), b.lineTo(g - y, Math.min(k, q)), b.stroke(), b.moveTo(g - y, Math.max(k, q)), b.lineTo(g - y, n), b.stroke(), ca(b, C, Math.min(k, q), D, Math.max(k, q), x[t].y[0] <= x[t].y[3] ? u.risingColor : f, z, e, A, A, !1, !1, u.fillOpacity), w && (e = P(E), c.strokeStyle = e, c.moveTo(g - y, m), c.lineTo(g - y, Math.min(k,
                                    q)), c.stroke(), c.moveTo(g - y, Math.max(k, q)), c.lineTo(g - y, n), c.stroke(), ca(c, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (b.moveTo(g - y, m), b.lineTo(g - y, n), b.stroke(), b.beginPath(), b.moveTo(g, k), b.lineTo(C, k), b.stroke(), b.beginPath(), b.moveTo(g, q), b.lineTo(D, q), b.stroke(), w && (e = P(E), c.strokeStyle = e, c.moveTo(g - y, m), c.lineTo(g - y, n), c.stroke(), c.beginPath(), c.moveTo(g, k), c.lineTo(C, k), c.stroke(), c.beginPath(), c.moveTo(g, q), c.lineTo(D, q), c.stroke()));
                                (x[t].indexLabel || u.indexLabel ||
                                    x[t].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: u.type,
                                    dataPoint: x[t],
                                    dataSeries: u,
                                    point: {
                ...
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height), c.restore());
                b.restore();
                return {
                    source: d,
                    dest: this.plotArea.ctx,
        ...
        l.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < A.length)
                        for (var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0; p < A.length; p++)
                            if (A[p].getTime ? h = A[p].x.getTime() : h = A[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(A[p].y) && A[p].y.length && "number" === typeof A[p].y[0] && "number" === typeof A[p].y[1] && "number" === typeof A[p].y[2] && "number" === typeof A[p].y[3] && "number" === typeof A[p].y[4] && 5 === A[p].y.length) {
                                ...
                                b.save();
                                0 < ba && (b.beginPath(), b.strokeStyle = ma, b.lineWidth = ba, b.setLineDash && b.setLineDash(N(J, ba)), b.moveTo(t - G, k), b.lineTo(t - G, g), b.stroke(), b.moveTo(t - G, n), b.lineTo(t - G, m), b.stroke());
                                b.restore();
                                ...
                                b.restore();
                                b.save();
                                0 < aa && (b.beginPath(), b.setLineDash && b.setLineDash(N(F, aa)), b.strokeStyle = Q, b.lineWidth = aa, b.moveTo(t - Y / 2 << 0, n - fa), b.lineTo(t + Y / 2 << 0, n -
                                    fa), b.stroke(), b.moveTo(t - Y / 2 << 0, g + fa), b.lineTo(t + Y / 2 << 0, g + fa), b.stroke());
                                b.restore();
                                w && (e = P(O), c.strokeStyle = e, c.lineWidth = ba, 0 < ba && (c.moveTo(t - E - G, k), c.lineTo(t - E - G, Math.max(g, n)), c.stroke(), c.moveTo(t - E - G, Math.min(g, n)), c.lineTo(t - E - G, m), c.stroke()), ca(c, D, Math.max(k, m), z, Math.min(k, m), e, 0, null, !1, !1, !1, !1), 0 < aa && (c.beginPath(), c.lineWidth = aa, c.moveTo(t + Y / 2, n - fa), c.lineTo(t - Y / 2, n - fa), c.stroke(), c.moveTo(t + Y / 2, g + fa), c.lineTo(t - Y / 2, g + fa), c.stroke()));
                ...
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                    0, 0, this.width, this.height), b.clearRect(f.x1, f.y1, f.width, f.height), c.restore());
                b.restore();
                return {
                    source: d,
                    dest: this.plotArea.ctx,
                    ...
                    if (0 < h.length)
                        for (var r =
                            ...
                            if (h[f].getTime ? g = h[f].x.getTime() : g = h[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
                                ...
                                var l = a.axisX.reversed ? c + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : c - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                        m) * k << 0,
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        ...
                        f && (t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                            c ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? v : 1))) << 0 : 0.03 * this.width);
                        ...
                        if (0 < D.length)
                            for (var F = C._colorSet, t = 0; t < D.length; t++) {
                                ...
                                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                    ...
                                    y(b, Math.min(m,
                                        n), Math.min(q, h), Math.max(n, m), Math.max(h, q), e, Q, aa, c);
                                    ...
                                    if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            indexKeyword: 1,
                                            point: {
                                                x: c ? D[t].y[1] >= D[t].y[0] ? n : m : m + (n - m) / 2,
                    ...
                    w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height),
                        a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.restore());
                    b.restore();
                    return {
                        source: d,
                        dest: this.plotArea.ctx,
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                                ...
                                if (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: r[f],
                                    dataSeries: h,
                                    indexKeyword: 0,
        ...
        l.prototype.renderRangeArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (var Q = !0; h < n.length; h++)
                            if (u = n[h].x.getTime ? n[h].x.getTime() : n[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))
                                if (null !== n[h].y && n[h].y.length && "number" === typeof n[h].y[0] && "number" === typeof n[h].y[1]) {
                                    ...
                                    q || Q ? (m.connectNullData && !q ? (c.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType &&
                                        m.lineDashType !== m.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = E, z = m.nullDataLineDashType, c.setLineDash(y)), c.lineTo(r, l), w && e.lineTo(r, l), g.push({
                                        x: r,
                                        y1: l,
                                        y2: s
                                    })) : (c.beginPath(), c.moveTo(r, l), x = {
                                        x: r,
                                        y: l
                                    }, g = [], g.push({
                                        x: r,
                                        y1: l,
                                        y2: s
                                    }), w && (e.beginPath(), e.moveTo(r, l))), Q = q = !1) : (c.lineTo(r, l), g.push({
                                        x: r,
                                        y1: l,
                                        y2: s
                                    }), w && e.lineTo(r, l), 0 == h % 250 && d());
                                    u = m.dataPointIds[h];
                                    this._eventManager.objectMap[u] = {
                                        id: u,
                                        objectType: "dataPoint",
                ...
                w && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                    0, 0, this.width, this.height), c.clearRect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.restore());
                c.restore();
                return {
                    source: b,
                    dest: this.plotArea.ctx,
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var f = 0; f < d.length - 3; f += 3) {
                            if (d[f].newStrokeStyle || d[f].newLineDashArray) c.stroke(),
                                c.beginPath(), c.moveTo(d[f].x, d[f].y), d[f].newStrokeStyle && (c.strokeStyle = d[f].newStrokeStyle), d[f].newLineDashArray && c.setLineDash(d[f].newLineDashArray);
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var h = f = 0; f < d.length - 3; f += 3, h++) {
                            if (l[h].newStrokeStyle || l[h].newLineDashArray) c.stroke(), c.beginPath(),
                                c.moveTo(d[f].x, d[f].y), l[h].newStrokeStyle && (c.strokeStyle = l[h].newStrokeStyle), l[h].newLineDashArray && c.setLineDash(l[h].newLineDashArray);
                            c.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        d = v(l, 2);
                        c.moveTo(d[0].x, d[0].y);
                        for (h = f = 0; f < d.length - 3; f += 3, h++) {
                            if (l[h].newStrokeStyle || l[h].newLineDashArray) c.stroke(), c.beginPath(), c.moveTo(d[f].x, d[f].y), l[h].newStrokeStyle && (c.strokeStyle = l[h].newStrokeStyle), l[h].newLineDashArray && c.setLineDash(l[h].newLineDashArray);
                            c.bezierCurveTo(d[f +
                            ...
                            if (q = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                ...
                                if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                    ...
                                    n < m.length - 1 && (A !== (m[n].lineColor || x) || C !== (m[n].lineDashType || k.lineDashType)) && (A = m[n].lineColor || x, l[l.length -
                                        1].newStrokeStyle = A, c.setLineDash && (m[n].lineDashType ? (C = m[n].lineDashType, l[l.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, l[l.length - 1].newLineDashArray = D)));
                    ...
                    if (0 < v.length)
                        for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, D = null, z = null, p = 0; p < v.length; p++)
                            if (v[p].getTime ?
                                ...
                                e = P(e);
                                w && ca(this._eventManager.ghostCtx, t, g, E, k, e, 0, null, !1,
                                    !1, !1, !1);
                                var aa, Q = t;
                                ...
                                0 < p && D && (!C || s.connectNullData) && (C && b.setLineDash && b.setLineDash(N(y, u)), b.beginPath(), b.moveTo(D, z - x), b.lineTo(Q, aa - x), 0 < u && b.stroke(), w && (c.beginPath(), c.moveTo(D, z - x), c.lineTo(Q, aa - x), 0 < u && c.stroke()));
                                C = !1;
                                D = E;
                                z = 0 < v[p].y ? g : k;
        ...
        var W = function(a, d, b, c, e, f, p, g, l) {
            if (!(0 > b)) {
                ...
                a.save();
                a.globalAlpha = g;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, b, f, p, !1), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, b, f, p, !1), 0 <= l && a.arc(d.x, d.y, l * b, p, f, !0), a.closePath(), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth =
                    2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        ...
        l.prototype.renderPie = function(a) {
            function d() {
                if (k && m) {
                    ...
                    p = f = 0;
                    n = !1;
                    for (e = 0; e < m.length; e++) g = h[(b + e) % m.length], 1 < a && (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !n ? (g.hemisphere = "right", f++) : (g.hemisphere = "left", n = !0));
                    n = !1;
                    for (e = 0; e < m.length; e++) g = h[(d + e) % m.length], 1 < c && (g.midAngle > 3 * Math.PI / 2 - u && g.midAngle < 3 * Math.PI / 2 + u) && (p <= c / 2 && !n ? (g.hemisphere = "left", p++) : (g.hemisphere = "right", n = !0))
                }
            }
            ...
            function b(a) {
                ...
                for (c = 0; c < m.length; c++) {
                    ...
                    if (d > b) {
                        ...
                        } else if (0 < Math.abs(h[c].center.x - A.x) || 0 < Math.abs(h[c].center.y - A.y)) h[c].center.x = A.x + e * (1 - a), h[c].center.y = A.y + f * (1 - a),
                            p = !0;
                ...
                a.lineJoin = "round";
                for (c = c = 0; c < m.length; c++) b = h[c], b.indexLabelText && (b.indexLabelTextBlock.y -= b.indexLabelTextBlock.height / 2, d = 0, d = "left" === b.hemisphere ? "inside" !==
                    k.indexLabelPlacement ? -(b.indexLabelTextBlock.width + n) : -b.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? n : -b.indexLabelTextBlock.width / 2, b.indexLabelTextBlock.x += d, b.indexLabelTextBlock.render(!0), b.indexLabelTextBlock.x -= d, b.indexLabelTextBlock.y += b.indexLabelTextBlock.height / 2, "inside" !== b.indexLabelPlacement && 0 < b.indexLabelLineThickness && (d = b.center.x + z * Math.cos(b.midAngle), e = b.center.y + z * Math.sin(b.midAngle), a.strokeStyle = b.indexLabelLineColor, a.lineWidth = b.indexLabelLineThickness,
                        a.setLineDash && a.setLineDash(N(b.indexLabelLineDashType, b.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(b.indexLabelTextBlock.x, b.indexLabelTextBlock.y), a.lineTo(b.indexLabelTextBlock.x + ("left" === b.hemisphere ? -n : n), b.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                a.save()
            }
            ...
            function e(a) {
                for (var b = null, d = 1; d < m.length; d++)
                    if (b = (a + d + h.length) % h.length, h[b].hemisphere !== h[a].hemisphere) {
                        b = null;
                        break
                    } else if (h[b].indexLabelText && b !== a && (0 > c(h[b], h[a]) || ("right" === h[a].hemisphere ? h[b].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y : h[b].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))) break;
                else b = null;
                return b
            }
                ...
                if (0 <= a && a < m.length) {
                    ...
                    for (g = 1; g < m.length; g++)
                        if (p = (a - g + h.length) % h.length, h[p].hemisphere !== h[a].hemisphere) {
                            p = null;
                            break
                        } else if (h[p].indexLabelText && h[p].hemisphere ===
                        h[a].hemisphere && p !== a && (0 > c(h[p], h[a]) || ("right" === h[a].hemisphere ? h[p].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y : h[p].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))) break;
                    else p = null;
                    t = p;
                    q = e(a);
                    g = p = 0;
                    0 > b ? (g = "right" === n.hemisphere ? t : q, k = b, null !== g && (t = -b, b = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (h[g].indexLabelTextBlock.y + h[g].indexLabelTextBlock.height / 2), b - t < r && (p = -t, g = f(g, p, d + 1), +g.toFixed(x) > +p.toFixed(x) && (k = b > r ? -(b - r) : -(t - (g - p)))))) : 0 < b && (g = "right" === n.hemisphere ?
                        q : t, k = b, null !== g && (t = b, b = h[g].indexLabelTextBlock.y - h[g].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2), b - t < r && (p = t, g = f(g, p, d + 1), +g.toFixed(x) < +p.toFixed(x) && (k = b > r ? b - r : t - (p - g)))));
                    k && (d = n.indexLabelTextBlock.y + k, b = 0, b = "right" === n.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)), n.midAngle > Math.PI / 2 - u && n.midAngle < Math.PI / 2 + u ? (p = (a - 1 + h.length) % h.length, p = h[p], a = h[(a + 1 + h.length) % h.length], "left" === n.hemisphere &&
        ...
        l.prototype.renderFunnel =
            function(a) {
                ...
                function c() {
                    if (u && x) {
                        for (var a, b, c, d, e, f, k, p, g, m, n, q, t, l, r, B = [], v = [], A = {
                                percent: null,
                                total: null
                            }, C = null, z = 0; z < x.length; z++) r = O[z],
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                        ...
                        if (-1 !== H) {
                            ...
                            if (u.reversed)
                                for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push(V), ca = G) : (a.push((F[G] - na + $ * X) / $), D.push((F[G] - na + ea * Z) / ea));
                            else
                                for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * X) / $), D.push((F[G] - na + ea * Z) / ea), ca = G) : (a.push(L), D.push(V));
        ...
        l.prototype.getPercentAndTotal = function(a, d) {
            var b = null,
                c = null,
                e = b = null;
            if (0 <= a.type.indexOf("stacked")) c = 0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], b = a.plotUnit.yAbsTotals[b], e = isNaN(d.y) ? 0 : 0 === b ? 0 : 100 * (d.y / b));
        ...
        l.prototype.replaceKeywordsWithValue = function(a, d, b, c, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                if ("x" === a)
                    if (b.axisX && "dateTime" ===
                        b.axisX.valueType || "dateTime" === b.xValueType || d.x && d.x.getTime) {
                        if (!b.axisX.logarithmic) return Aa(h, d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
        ...
        F.prototype.setLayout = function() {
            ...
            var l = [],
                k = [];
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", b = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height;
                ...
                if (n.dataPoints && n.dataPoints.length)
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        var q = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ?
                            ...
                            h = n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                chart: this.chart,
                                legend: this.options,
                                dataSeries: n,
                                dataPoint: null
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var A = n.dataPoints[x],
                                ...
                                h = A.legendText ? A.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                    chart: this.chart,
                                    legend: this.options,
                                    dataSeries: n,
                                    dataPoint: A
                ...
                for (m = 0; m < l.length; m++) {
                    ...
                    if (!(0 >= p || "undefined" === typeof p || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!n || n.width + Math.round(q.textBlock.width + w + g + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) n = {
                                items: [],
                                width: 0
                            }, k.push(n), this.height += h, h = 0;
                            ...
                            new ia(this.ctx, {
                                ...
                                fontStyle: this.fontStyle,
                                textBaseline: "middle"
                            }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + g + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < p - this.lineHeight ? (n = {
                                items: [],
                                width: 0
            ...
            "top" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, c = d.y1) : "center" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, c = d.y1 + d.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (e = "left" === this.horizontalAlign ?
                d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, c = d.y2 - this.height);
            this.items = l;
            for (m = 0; m < this.items.length; m++) q = l[m], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = {
                id: q.id,
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "error":
                                a >=
                                    q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (c.push({
                                        dataPoint: h,
                                        dataPointIndex: f,
                                        dataSeries: this,
                            ...
                            case "doughnut":
                                ...
                                r < q.radius && r > w && (r = Math.atan2(d - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < q.endAngle && (w = 360), s >= w && 0 !== h.y && (w += 360, r < s && (r += 360)), r > s && r < w && (c.push({
                                    dataPoint: h,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
                            ...
                            case "pyramid":
                                r = q.funnelSection;
                                d > r.y1 && d < r.y4 && (r.y6 ? d > r.y6 ? (f = r.x6 + (r.x5 - r.x6) / (r.y5 - r.y6) * (d - r.y6), r = r.x3 + (r.x4 - r.x3) / (r.y4 - r.y3) * (d - r.y3)) : (f = r.x1 + (r.x6 - r.x1) / (r.y6 - r.y1) * (d - r.y1), r = r.x2 + (r.x3 - r.x2) / (r.y3 - r.y2) * (d - r.y2)) : (f = r.x1 + (r.x4 - r.x1) / (r.y4 - r.y1) * (d - r.y1), r = r.x2 + (r.x3 - r.x2) / (r.y3 - r.y2) * (d - r.y2)), a > f && a < r && (c.push({
                                    dataPoint: h,
                                    dataPointIndex: q.dataPointIndex,
                                    dataSeries: this,
                                    distance: 0
                            ...
                            case "boxAndWhisker":
                                if (a >=
                                    q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4) c.push({
                                    dataPoint: h,
                                    dataPointIndex: f,
                                    dataSeries: this,
                            ...
                            case "candlestick":
                                ...
                                break;
                            case "ohlc":
                                if (Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y2 && d <= q.y3 || a >= q.x1 && a <= (q.x2 + q.x1) / 2 && d >= q.y1 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || a >= (q.x1 + q.x2) / 2 && a <= q.x2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y4 + q.borderThickness / 2) c.push({
                                    dataPoint: h,
                                    dataPointIndex: f,
                                    dataSeries: this,
        ...
        E.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) / Math.log(d / this.viewportMinimum) <
                    this.noTicks - 1) {
                    for (var b = E.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), c = Math.ceil(this.viewportMinimum / b) * b; c < d; c += b) c < this.viewportMinimum || this.logLabelValues.push(c);
        ...
        E.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), c = 0, h = q; c < this.logLabelValues.length; c++)
                        if (b =
                            ...
                            }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : ea(m, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: p,
                ...
                for (b = this.intervalStartPosition; b <= e; b = parseFloat(1E-12 > this.interval ? this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase,
                    ...
                    if (f = 0.9 * g >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (b = 0; b < this._labels.length; b++)
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                for (var v, h = a.text.split(" "), c = 0; c < h.length; c++) m = h[c], this.ctx.font = a.fontStyle + " " +
                        ...
                        for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((c - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c), m = (k - (l + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth)) this.options.labelMaxWidth <
                                                f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = c) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = p);
                                            else if (!s(d))
                                            if (c = r.width + d.width >> 0, h = this.labelFontSize, q < f) c - 2 * f > n && (n = c - 2 * f, c >= 2 * f && c < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ?
                                                ...
                                                h : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : c >= 3.2 * f && c < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = this.labelFontSize) : c > 3.6 * f && c < 5 * f ? (s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : c > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = h, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelAngle = this.labelAngle));
                                            else if (v === b && (0 === v && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > n || v === this._labels.length - 1 && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > n || 0 < v && v < this._labels.length - 1 && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > n &&
            ...
            if ("normal" === e) {
                for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 >
                    ...
                    var G = 0,
                        ...
                        $ = 0;
                    if (b && 0 < b.length)
                        for (y = [], h = O = 0; h < b.length; h++) y.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)), O += y[h], L += b[h] && !m.isNavigator ? b[h].margin : 0;
                    else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    P.push(y);
                    if (c && 0 < c.length)
                        for (D = [], h = $ = 0; h < c.length; h++) D.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)), $ += D[h], Z += c[h] ? c[h].margin : 0;
                    ...
                    if (a && 0 < a.length)
                        for (h =
                            ...
                            g, a[h].lineCoordinates.y2 = g + a[h].lineThickness / 2, "inside" === a[h].labelPlacement && 0 < h && (a[h].lineCoordinates.y1 = a[h].lineCoordinates.y1 + x[h] - (a[h]._titleTextBlock ? a[h]._titleTextBlock.height : 0) - ("inside" === a[h].tickPlacement ? a[h].tickLength : 0), a[h].lineCoordinates.y2 = a[h].lineCoordinates.y1 + a[h].lineThickness / 2), a[h].bounds = {
                                x1: p,
                                y1: g,
                                x2: l,
                                y2: k - (T + e - x[h] - G),
                    ...
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++) L = m.isNavigator ? 0 : 10, b[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2 : n, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[0].textBlock.height /
                            2 : n, k = Math.round(f.y2 - T - e - L), b[h].lineCoordinates = {
                                x1: p - U,
                                y1: g,
                                x2: l - U,
                                y2: k,
                                height: Math.abs(k - g)
                            }, "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.x1 = b[h].lineCoordinates.x1 - (y[h] - (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)) + ("outside" === b[h].tickPlacement ? b[h].tickLength : 0), b[h].lineCoordinates.x2 = b[h].lineCoordinates.x1 + b[h].lineThickness / 2), b[h].bounds = {
                                x1: p - (y[h] + U),
                                y1: g,
                                x2: l,
                                y2: k,
                                width: l - p,
                                height: k - g
                            }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth <
                                b[h].lineCoordinates.height ? b[h].titleMaxWidth : b[h].lineCoordinates.height), U += y[h] + b[h].margin);
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) c[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), l = Math.round(p), L = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : 0, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), L = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (T + e + L)), c[h].lineCoordinates = {
                            x1: p + X,
                            y1: g,
                            x2: p + X,
                            y2: k,
                            height: Math.abs(k - g)
                        }, "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.x1 = c[h].lineCoordinates.x1 + (D[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0)) - ("outside" === c[h].tickPlacement ? c[h].tickLength : 0) - 2, c[h].lineCoordinates.x2 = c[h].lineCoordinates.x1 + c[h].lineThickness / 2), c[h].bounds = {
                            x1: p,
                            y1: g,
                            x2: l + (D[h] + X),
                            y2: k,
                            width: l - p,
                            height: k - g
                        }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.height ? c[h].titleMaxWidth :
                            c[h].lineCoordinates.height), X += D[h] + c[h].margin);
                    if (a && 0 < a.length)
                    ...
                    if (0 < w) {
                        ...
                        if (b && 0 < b.length)
                            for (h = 0; h < b.length; h++) J = P[w - 1][h] === P[w][h] ? !0 : !1;
                        else J = !0;
                        if (c && 0 < c.length)
                            for (h = 0; h < c.length; h++) K = R[w -
                                1][h] === R[w][h] ? !0 : !1;
                        else K = !0
                    }
                    if (r && H && J && K) break;
                ...
                for (N = []; 4 > w;) {
                    ...
                    N.push(v);
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++) b[h].lineCoordinates = {}, p = Math.round(f.x1 + X + e), l = Math.round(f.x2 - T - W > m.width - 10 ? m.width - 10 : f.x2 - T - W), b[h].labelAutoFit && !s(x) && (0 < !a.length && (p = 0 > b[h].labelAngle ? Math.max(p, x) : 0 === b[h].labelAngle ? Math.max(p, x / 2) : p), 0 < !d.length && (l = 0 < b[h].labelAngle ? l - A / 2 : 0 === b[h].labelAngle ? l - A / 2 : l)), b[h].lineCoordinates.x1 = p, b[h].lineCoordinates.x2 = l, b[h].lineCoordinates.width = Math.abs(l - p), b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth <
                            b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width);
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) c[h].lineCoordinates = {}, p = Math.round(f.x1 + X + e), l = Math.round(f.x2 - T - W > c[h].chart.width - 10 ? c[h].chart.width - 10 : f.x2 - T - W), c[h] && c[h].labelAutoFit && !s(y) && (0 < !a.length && (p = 0 < c[h].labelAngle ? Math.max(p, y) : 0 === c[h].labelAngle ? Math.max(p, y / 2) : p), 0 < !d.length && (l -= D / 2)), c[h].lineCoordinates.x1 = p, c[h].lineCoordinates.x2 = l, c[h].lineCoordinates.width = Math.abs(l - p), c[h].title && (c[h]._titleTextBlock.maxWidth =
                            0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (n = [], h = U = 0; h < b.length; h++) n.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)), U += n[h] + b[h].margin, L += b[h].margin;
                    else n.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    E.push(n);
                    if (c && 0 < c.length)
                        for (z = [], h = S = 0; h < c.length; h++) z.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)), S += z[h], Z += c[h].margin;
                    else z.push(Math.ceil(c[0] ?
                        c[0].createLabelsAndCalculateHeight() : 0));
                    u.push(z);
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++) 0 < b[h]._labels.length && (k = b[h]._labels[0], g = b[h]._labels[b[h]._labels.length - 1], x = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), A = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)));
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) c[h] && 0 < c[h]._labels.length && (k = c[h]._labels[0], g = c[h]._labels[c[h]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), D = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)));
                    if (m.panEnabled)
                        for (h = 0; h < b.length; h++) n[h] = s(m.sessionVariables.axisY.height) ?
                            m.sessionVariables.axisY.height = n[h] : m.sessionVariables.axisY.height;
                    else
                        for (h = 0; h < b.length; h++) m.sessionVariables.axisY.height = n[h];
                    if (b && 0 < b.length)
                        for (h = b.length - 1; 0 <= h; h--) g = Math.round(f.y2), k = Math.round(f.y2 > b[h].chart.height ? b[h].chart.height : f.y2), b[h].lineCoordinates.y1 = g - (n[h] + b[h].margin + V), b[h].lineCoordinates.y2 = g - (n[h] + b[h].margin + V), "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.y1 = b[h].lineCoordinates.y1 + n[h] - (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0) - ("inside" ===
                            b[h].tickPlacement ? b[h].tickLength : 0), b[h].lineCoordinates.y2 = b[h].lineCoordinates.y1 + b[h].lineThickness / 2), b[h].bounds = {
                            x1: p,
                            ...
                            width: l - p,
                            height: n[h]
                        }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width), V += n[h] + b[h].margin;
                    if (c && 0 < c.length)
                        for (h = c.length - 1; 0 <= h; h--) c[h] && (g = Math.round(f.y1), k = Math.round(f.y1 + (z[h] + c[h].margin + G)), c[h].lineCoordinates.y1 =
                            k, c[h].lineCoordinates.y2 = k, "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.y1 = k - z[h] + (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0)), c[h].bounds = {
                                x1: p,
                                y1: g + (c[h].margin + G),
                                x2: l,
                                y2: k,
                                width: l - p,
                                height: S
                            }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width), G += z[h] + c[h].margin);
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++) {
                            ...
                            k = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : f.y2 - U > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - U) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (l = 0 > b[L].labelAngle ? Math.max(l, x) : 0 === b[L].labelAngle ? Math.max(l, x / 2) : l, p =
                                    0 > b[L].labelAngle || 0 === b[L].labelAngle ? l - X : p);
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (l = c[L].lineCoordinates.x1, p = l - X);
                            a[h].lineCoordinates = {
                                x1: l - P,
                                y1: g,
                                x2: l - P,
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) {
                            ...
                            p = Math.round(f.x1 - e);
                            g = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y2 : f.y1 <
                                Math.max(L, 10) ? Math.max(L, 10) : f.y1) : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1;
                            l = Math.round(f.x2 - T - W);
                            k = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : f.y2 - U > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - U) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (l = 0 > b[L].labelAngle ? Math.max(l, x) : 0 === b[L].labelAngle ? Math.max(l, x / 2) : l, p = 0 > b[L].labelAngle || 0 === b[L].labelAngle ? l - T : p);
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] &&
                                    c[L].labelAutoFit && (l = c[L].lineCoordinates.x2, p = l - T);
                            d[h].lineCoordinates = {
                                x1: l + R,
                                y1: g,
                                x2: l + R,
                    ...
                    if (0 < w) {
                        ...
                        if (b && 0 < b.length)
                            for (h = 0; h < b.length; h++) J = E[w - 1][h] === E[w][h] ? !0 : !1;
                        else J = !0;
                        if (c && 0 < c.length)
                            for (h = 0; h < c.length; h++) K = u[w - 1][h] === u[w][h] ? !0 : !1;
                        else K = !0
                    }
                    if (r && H && J && K) break;
                    w++
        ...
        E.prototype.renderLabelsTicksAndTitle = function() {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var b = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, l = this.viewportMaximum, s = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length -
                            ...
                            n.position > this.viewportMaximum || !(k === this._labels.length - 1 || g < Math.log(l / n.position) * s / e) || (b.push(n), l = n.position, g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = b
                    } else {
                        for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height *
                            Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += g);
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        ...
                        for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (m = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += m);
            ...
            if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function() {
                for (k = 0; k < a._labels.length; k++) n = a._labels[k], n.position < a.viewportMinimum || (n.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), n.textBlock.render(!0), a.ctx.restore())
            }, this);
            else
        ...
        E.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines &&
                ...
                for (c = 0; c < this._stripLineLabels.length; c++)
                    ...
                    this.ctx.clip();
                    for (c = 0; c < l.length; c++) k =
                        l[c], k.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                            this.ctx.save();
                            this.ctx.beginPath();
                            this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                            this.ctx.clip();
                    ...
                    for (c = 0; c < w.length; c++) b = w[c], b.stripLine.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                ...
                if (g)
                    for (g = !1, c = 0; c < w.length; c++) b = w[c], "outside" === b.stripLine.labelPlacement && b.textBlock.render(!0)
            }
        };
            ...
            if (this.gridThickness && 0 < this.gridThickness) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    for (c = 0; c < this._labels.length; c++) this._labels[c].position < this.viewportMinimum || (this._labels[c].position > this.viewportMaximum ||
                        this._labels[c].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[c].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) + 0.5 : d.x << 0, a.moveTo(d, b.y1 << 0), a.lineTo(d, b.y2 << 0), a.stroke());
                else if ("left" === this._position || "right" === this._position)
                    for (var c = 0; c < this._labels.length; c++) this._labels[c].position < this.viewportMinimum || (this._labels[c].position > this.viewportMaximum || this._labels[c].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[c].position), d =
                        1 === a.lineWidth % 2 ? (d.y << 0) + 0.5 : d.y << 0, a.moveTo(b.x1 << 0, d), a.lineTo(b.x2 << 0, d), a.stroke());
                a.restore()
            }
        };
            ...
            if ("bottom" === this._position || "top" === this._position) {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                            ...
                            for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(e,
                                g), d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + b, g), e = this.scaleBreaks._appliedBreaks[l].endPixel + c;
                ...
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                    if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                        ...
                        for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(g, e), d.lineTo(g, this.scaleBreaks._appliedBreaks[l].startPixel + c), e = this.scaleBreaks._appliedBreaks[l].endPixel + b;
                            ...
                            if (d)
                                if (e[b].startValue < this.conversionParameters.minimum) {
                                    if (1 < e[b].size && this.conversionParameters.minimum * Math.pow(e[b].endValue / e[b].startValue, Math.log(c) / Math.log(e[b].size)) < e[b].endValue) {
                                        ...
                                        break
                                    } else a *= e[b].endValue / this.conversionParameters.minimum / Math.pow(e[b].size, Math.log(e[b].endValue / this.conversionParameters.minimum) /
                                        Math.log(e[b].endValue / e[b].startValue)), c /= Math.pow(e[b].size, Math.log(e[b].endValue / this.conversionParameters.minimum) / Math.log(e[b].endValue / e[b].startValue));
                                    d = !1
                            ...
                            if (d)
                                if (e[b].startValue < this.conversionParameters.minimum) {
                                    if (e[b].size && this.conversionParameters.minimum + c * (e[b].endValue - e[b].startValue) / e[b].size < e[b].endValue) {
                                        ...
                                        e[b].size * (e[b].endValue - this.conversionParameters.minimum) / (e[b].endValue - e[b].startValue), c -= e[b].size * (e[b].endValue - this.conversionParameters.minimum) / (e[b].endValue - e[b].startValue);
                                    d = !1
                                } else if (c > e[b].startValue - this.conversionParameters.minimum) {
                            c -= e[b].startValue - this.conversionParameters.minimum;
                            if (c < e[b].size) {
        ...
        E.prototype.getApparentDifference = function(a, d, b, c) {
            ...
            if (this.logarithmic) {
                b = s(b) ? d / a : b;
                for (var f = 0; f < e.length && !(d < e[f].startValue); f++) a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? b = b / e[f].endValue * e[f].startValue * e[f].size : a >= e[f].startValue && d >= e[f].endValue ? b = b / e[f].endValue * a * Math.pow(e[f].size, Math.log(e[f].endValue / a) / Math.log(e[f].endValue / e[f].startValue)) : a <= e[f].startValue && d <= e[f].endValue ? b = b / d * e[f].startValue * Math.pow(e[f].size, Math.log(d / e[f].startValue) / Math.log(e[f].endValue / e[f].startValue)) : !c && (a > e[f].startValue && d < e[f].endValue) &&
                    (b = a * Math.pow(e[f].size, Math.log(d / a) / Math.log(e[f].endValue / e[f].startValue))))
            } else
                for (b = s(b) ? Math.abs(d - a) : b, f = 0; f < e.length && !(d < e[f].startValue); f++) a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? b = b - e[f].endValue + e[f].startValue + e[f].size : a > e[f].startValue && d >= e[f].endValue ? b = b - e[f].endValue + a + e[f].size * (e[f].endValue - a) / (e[f].endValue - e[f].startValue) : a <= e[f].startValue && d < e[f].endValue ? b = b - d + e[f].startValue + e[f].size * (d - e[f].startValue) / (e[f].endValue - e[f].startValue) : !c && (a > e[f].startValue &&
                    d < e[f].endValue) && (b = a + e[f].size * (d - a) / (e[f].endValue - e[f].startValue)));
            return b
        };
        ...
        E.prototype.calculateValueToPixelConversionParameters =
            function(a) {
                ...
                if (this.logarithmic)
                    for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? b = 0 : this.viewportMinimum <= a[e].startValue &&
                        this.viewportMaximum >= a[e].endValue ? (c = c / a[e].endValue * a[e].startValue, b = 0 < a[e].spacing.toString().indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100) : b - Math.min(a[e].spacing, 0.1 * b)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c / a[e].endValue * this.viewportMinimum, b = 0 < a[e].spacing.toString().indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100 * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : b - Math.min(a[e].spacing, 0.1 * b) * Math.log(a[e].endValue /
                            this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (c = c / this.viewportMaximum * a[e].startValue, b = 0 < a[e].spacing.toString().indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100 * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)) : b - Math.min(a[e].spacing, 0.1 * b) * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)));
                else
                ...
                if ("left" === this._position || "right" === this._position) this.logarithmic ?
                    (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? 1 : -1) * b * d.lnLogarithmBase / Math.log(Math.abs(c))) : d.pixelPerUnit = (this.reversed ? 1 : -1) * b / Math.abs(c), d.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2;
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if (this.scaleBreaks)
                    for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++)
                        if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[c].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue) && (!s(this.sessionVariables.newViewportMaximum) &&
                                this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue || !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[c].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue)) {
                    ...
                    isFinite(f) ? isFinite(e) ? isFinite(f) || (f = e) : e = f : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (c = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += c, e -= c) : e > f ? (c = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - c : f = isFinite(e) ? e + c : 0) : (c = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += c), 0 !== e && (e -=
                        c)), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < e && (e = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > f && (f = 0));
                ...
                if ("axisX" === this.type && b) {
                    this.intervalType ||
                        (c / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : c / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : c / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : c / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : c / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : c / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : c / 100 <= a ? (this.interval = 100, this.intervalType = "millisecond") : c / 200 <= a ? (this.interval = 200, this.intervalType = "millisecond") : c / 250 <= a ? (this.interval = 250, this.intervalType =
                            ...
                            a ? (this.interval = 3, this.intervalType = "month") : c / (6 * R.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = c / (1 * R.yearDuration) <= a ? 1 : c / (2 * R.yearDuration) <= a ? 2 : c / (4 * R.yearDuration) <= a ? 4 : Math.floor(E.getNiceNumber(c / (a - 1), !0) / R.yearDuration), this.intervalType = "year"));
        ...
        E.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (this.scaleBreaks)
                for (g =
                    ...
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[g].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[g].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[g].startValue) && (!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[g].endValue ||
                            !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[g].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[g].endValue)) {
                        this.scaleBreaks._appliedBreaks.splice(g, 1);
                        break
                    }
            "axisX" === this.type ? (c = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 1 === e / c && (g = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ?
            ...
            if (null === this.minimum || null === this.maximum) "axisX" === this.type ? (c = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 1 === e / c && (g = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval), e *= g, c /= g), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / c > this.logarithmBase ? e / c * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (c = null !== this.minimum ?
        ...
        T.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (c = 1 === n % 2 ? (c.x << 0) + 0.5 : c.x << 0, g = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: c - n / 2,
                            y1: e,
                            x2: g + n / 2,
                            y2: l
                        }, this.ctx.moveTo(c,
                            e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(c, l), this.ctx.lineTo(g, l), this.ctx.lineTo(g, e);
                    ...
                    if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === n % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, g = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2,
                            g = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: c,
                            y1: e - n / 2,
                            x2: g,
                            y2: l + n / 2
                        }, this.ctx.moveTo(c, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, e), this.ctx.lineTo(g, l), this.ctx.lineTo(c, l);
                    else if ("wavy" === this.type) {
                    s = c;
                    k = e;
                    f = 0.5;
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 ===
                    this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = {
                        x1: e - d / 2,
                        y1: g,
                        x2: f + d / 2,
                        y2: l
                    };
                else if ("left" === this.parent._position || "right" === this.parent._position) g = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = {
                    x1: e,
                    y1: g - d / 2,
                    x2: f,
                    y2: l + d / 2
        ...
        $.prototype.showAt = function(a) {
            ...
            for (c = 0; c < d.axisX.length; c++) a = d.axisX[c]._crosshairValue, d.axisX[c].crosshair && (d.axisX[c].crosshair.enabled && !s(a) && a >= d.axisX[c].viewportMinimum && a <= d.axisX[c].viewportMaximum) && (d.axisX[c].showCrosshair(a), d.axisX[c].crosshair._updatedValue = a, this === d.axisX[c].crosshair && (b = !0));
            for (c = 0; c < d.axisX2.length; c++) a = d.axisX2[c]._crosshairValue, d.axisX2[c].crosshair &&
                (d.axisX2[c].crosshair.enabled && !s(a) && a >= d.axisX2[c].viewportMinimum && a <= d.axisX2[c].viewportMaximum) && (d.axisX2[c].showCrosshair(a), d.axisX2[c].crosshair._updatedValue = a, this === d.axisX2[c].crosshair && (b = !0));
            for (c = 0; c < d.axisY.length; c++) a = d.axisY[c]._crosshairValue, d.axisY[c].crosshair && (d.axisY[c].crosshair.enabled && !s(a) && a >= d.axisY[c].viewportMinimum && a <= d.axisY[c].viewportMaximum) && (d.axisY[c].showCrosshair(a), d.axisY[c].crosshair._updatedValue = a, this === d.axisY[c].crosshair && (b = !0));
            for (c = 0; c <
                d.axisY2.length; c++) a = d.axisY2[c]._crosshairValue, d.axisY2[c].crosshair && (d.axisY2[c].crosshair.enabled && !s(a) && d._crosshairY2Value >= d.axisY2[c].viewportMinimum && d._crosshairY2Value <= d.axisY2[c].viewportMaximum) && (d.axisY2[c].showCrosshair(a), d.axisY2[c].crosshair._updatedValue = a, this === d.axisY2[c].crosshair && (b = !0));
        ...
        $.prototype.render = function(a, d, b) {
            ...
            if (!this.valueFormatString)
                if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString;
                    ...
                    var n = 0,
                        n = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ?
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === m[0].dataSeries.type ||
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), A = u =
                                0, r = y = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), C = A = u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x < m[r].dataPoint.y.length; x++) u =
                                    Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r);
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[c]) <<
                            ...
                            }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y[c], this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar" === this.parent.dataSeries[y].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            A = u = 0;
                            for (r = y; 0 <= r; r--) A += m[r].dataPoint.y, u = Math.abs(a -
                                this.parent.convertValueToPixel(A)), u < v && (v = u, c = r);
                            ...
                            }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[y].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            C = A = u = 0;
                            for (r = y; 0 <= r; r--) A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, c = r);
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: b ? b : C
                            }) : s(this.options.label) ? ea(b ?
                                b : C, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, this.value = x.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: b ? b : x.dataPoint.y
                        ...
                        if (this.parent.labels)
                            ...
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({
                                        y: d
                                    }), v = null, y = 0; y < this.parent.dataSeries.length; y++)(v =
                                    this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: x.dataPoint.x
                            ...
                            }) : s(this.options.label) ? Aa(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) :
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: b ? b : x.dataPoint.x
                            }) : s(this.options.label) ? ea(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y &&
                    ...
                    if (this.parent.labels)
                        ...
                        if ("axisX" ===
                            ...
                            for (r = this.parent.convertPixelToValue({
                                    x: a
                                }), v = null, y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                        ...
                        crosshair: this.options,
                        value: x.dataPoint.x
                    }) : s(this.options.label) ? Aa(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: x.dataPoint.x
                    ...
                    for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r,
                        !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        for (r = u = 0; r < x.dataPoint.y.length; r++) u =
                            Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r])), u < v && (v = u, c = r);
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        A = u = 0;
                        for (r = y; 0 <= r; r--) A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, c = r);
                        w =
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: b ? b : C
                        }) : s(this.options.label) ? ea(b ? b : C, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = C
                        ...
                        }) : s(this.options.label) ? ea(b ? b : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) <<
                        0, k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: x.dataPoint.y
                        }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataPoint.y);
                    f = g = w;
                    c = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) c = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, g = this.chart.plotArea.y2, this.bounds = {
                    x1: c - n / 2,
                    y1: f,
                    x2: e + n / 2,
                    y2: g
                };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = g = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, c = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
                    this.bounds = {
                        x1: c,
                        y1: f - n / 2,
                        x2: e,
                    ...
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (this.parent.labels)
                            ...
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({
                                        y: d
                                    }), v = null, y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index &&
                                    (k.text = this.labelFormatter ? this.labelFormatter({
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                            ...
                            }) : s(this.options.label) ? Aa(b ? b : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: b ? b : this.parent.convertPixelToValue(d)
                            }) : s(this.options.label) ? ea(b ? b : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: b ? b : this.parent.convertPixelToValue(a)
                        }) : s(this.options.label) ? ea(b ? b : this.parent.convertPixelToValue(a),
                    ...
                    if (this.parent.labels)
                        ...
                        if ("axisX" === this.parent.type)
                            for (r = this.parent.convertPixelToValue({
                                ...
                                crosshair: this.options,
                                value: b ? b : this.parent.convertPixelToValue(a)
                            }) : s(this.options.label) ? b ? b : v.dataPoint.label : this.label)
                    } else "dateTime" ===
                        this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: b ? b : this.parent.convertPixelToValue(a)
                        }) : s(this.options.label) ? Aa(b ? b : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: b ? b : 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : ""
                        }) : s(this.options.label) ? ea(b ? b : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    k.x = c - k.measureText().width / 2;
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var v = 0; v < this.chart.axisX.length; v++) {
                                for (var g = this.chart.axisX[v].convertPixelToValue({
                                            y: d
                                        }), k =
                                        null, c = 0; c < this.chart.axisX[v].dataSeries.length; c++)(k = this.chart.axisX[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[c], null !== k.dataPoint.y && l.push(k));
                                k = null
                            }
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++) {
                                g = this.chart.axisX2[v].convertPixelToValue({
                                    y: d
                                });
                                k = null;
                                for (c = 0; c < this.chart.axisX2[v].dataSeries.length; c++)(k = this.chart.axisX2[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[c],
                        ...
                        if (this.chart.axisX)
                            for (v = 0; v < this.chart.axisX.length; v++)
                                for (g = this.chart.axisX[v].convertPixelToValue({
                                        x: a
                                    }), k = null, c = 0; c < this.chart.axisX[v].dataSeries.length; c++)(k = this.chart.axisX[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[c], null !== k.dataPoint.y && l.push(k));
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++)
                                for (g = this.chart.axisX2[v].convertPixelToValue({
                                        x: a
                                    }), k = null, c = 0; c < this.chart.axisX2[v].dataSeries.length; c++)(k =
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        k = {};
                        if (0 <= this.currentDataPointIndex) c = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint =
                            c, k.index = this.currentDataPointIndex, k.distance = Math.abs(c.x - g), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    var c = this.chart.data[e.dataSeriesIndex],
                        ...
                        g = e.dataPointIndex;
                    !1 === f.highlightEnabled || !0 !== c.highlightEnabled && !0 !== f.highlightEnabled ||
        ...
        X.prototype.getToolTipInnerHTML = function(a) {
            ...
            for (var d = null, b = null, c = null, e = 0, f = "", g = !0, l = 0; l < a.length; l++)
                ...
                for (var s = null, k = "", l = 0; l < a.length; l++) b = a[l].dataSeries, c = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (g && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? k += "undefined" !== typeof this.chart.axisX[0].labels[c.x] ?
                    ...
                    null === d && (d = ""), !0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(f, c, b, e) + d, l < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, c, b, e), l < a.length - 1 && (d += "</br>")));
                null !== d && (d = k + d)
            } else {
                b = a[0].dataSeries;
                c = a[0].dataPoint;
        ...
        X.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var g = 0; g < this.chart.data.length; g++) b = this.chart.data[g], (c = b.getDataPointAtX(a, !1)) && (c.dataPoint && !s(c.dataPoint.y) && b.visible) && (c.dataSeries = b, f.push(c));
            else b = this.chart.data[d], (c = b.getDataPointAtX(a, !1)) && (c.dataPoint && !s(c.dataPoint.y) && b.visible) && (c.dataSeries = b, f.push(c));
            if (0 < f.length) {
                for (g = 0; g < f.length; g++)
                    if (c = f[g], c.dataPoint.x < c.dataSeries.axisX.viewportMinimum ||
                        c.dataPoint.x > c.dataSeries.axisX.viewportMaximum || c.dataPoint.y < c.dataSeries.axisY.viewportMinimum || c.dataPoint.y > c.dataSeries.axisY.viewportMaximum) e = !0;
                    else {
                        e = !1;
                        break
                ...
                if (null !== c) {
                    ...
                    "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type || "funnel" === f[0].dataSeries.type || "pyramid" === f[0].dataSeries.type ? b = mouseX - 10 - this.container.clientWidth : (b = "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y) -
                        this.container.clientWidth << 0 : f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) - this.container.clientWidth << 0, b -= 10);
            ...
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c])
                    if (c = this.objectMap[c], "dataPoint" === c.objectType) {
                        ...
                        c.objectType && (e = this.chart.data[c.dataSeriesIndex], f = null !== c.dataPointIndex ? e.dataPoints[c.dataPointIndex] : null, c.eventParameter = {
                            x: b.x,
                            y: b.y,
                            dataSeries: e.options,
                            dataPoint: f,
        ...
        ha.prototype.animate = function(a, d, b, c, e) {
            ...
            for (a = []; 0 < this.animations.length;)
                if (d = this.animations.shift(), b = (new Date).getTime(), c = 0, d.startTime <= b && (c = e(Math.min(b - d.startTime,
        ...
        var K = {
            ...
            V = {
                ...
                drawMarkers: function(a) {
                    for (var d = 0; d < a.length; d++) {
                        var b = a[d];
                        V.drawMarker(b.x, b.y, b.ctx, b.type,

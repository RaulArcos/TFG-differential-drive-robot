...
class RAH01Action:
    def __init__(self) -> None:
        ...
        self._pid_angular = PIDController(0.04, 0.001, 0.0001)
        self._pid_linear = PIDController(0.4, 0.001, 0.0001)

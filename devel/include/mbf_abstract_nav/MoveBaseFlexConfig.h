  ...
  public:
    ...
    void setParams(MoveBaseFlexConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("oscillation_angle"==(*_i)->name){oscillation_angle = boost::any_cast<double>(val);}
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.oscillation_angle = 0.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.oscillation_angle = 6.28;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.oscillation_angle = 3.14;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<double>("oscillation_angle", "double", 0, "How far in radian the robot must rotate to be considered not to be oscillating", "", &MoveBaseFlexConfig::oscillation_angle)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<double>("oscillation_angle", "double", 0, "How far in radian the robot must rotate to be considered not to be oscillating", "", &MoveBaseFlexConfig::oscillation_angle)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"

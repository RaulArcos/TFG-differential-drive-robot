...
struct MD5Sum< ::mbf_msgs::GetPathAction_<ContainerAllocator> >
{
  ...
  {
    return "30a72de8fdd422809b5652337191ad66";
  }

  static const char* value(const ::mbf_msgs::GetPathAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x30a72de8fdd42280ULL;
  static const uint64_t static_value2 = 0x9b5652337191ad66ULL;
};

...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef MISSED_PATH
#endif
#if defined(_WIN32) && defined(BLOCKED_GOAL)
  #undef BLOCKED_GOAL
#endif
  ...
  enum {
    ...
    INVALID_PATH = 111u,
    TF_ERROR = 112u,
    NOT_INITIALIZED = 113u,
    INVALID_PLUGIN = 114u,
    INTERNAL_ERROR = 115u,
    OUT_OF_MAP = 116u,
    MAP_ERROR = 117u,
    STOPPED = 118u,
    ERROR_RANGE_START = 100u,
    ERROR_RANGE_END = 149u,
    PLUGIN_ERROR_RANGE_START = 121u,
    PLUGIN_ERROR_RANGE_END = 149u,
  };
...
struct MD5Sum< ::mbf_msgs::ExePathResult_<ContainerAllocator> >
{
  ...
  {
    return "24db3f9a645000fb596fe385d5c7c643";
  }

  static const char* value(const ::mbf_msgs::ExePathResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x24db3f9a645000fbULL;
  static const uint64_t static_value2 = 0x596fe385d5c7c643ULL;
};

...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef INVALID_GOAL
#endif
#if defined(_WIN32) && defined(BLOCKED_START)
  #undef BLOCKED_START
#endif
  ...
  enum {
    ...
    MAP_ERROR = 64u,
    STOPPED = 65u,
    ERROR_RANGE_START = 50u,
    ERROR_RANGE_END = 99u,
    PLUGIN_ERROR_RANGE_START = 71u,
    PLUGIN_ERROR_RANGE_END = 99u,
  };
...
struct MD5Sum< ::mbf_msgs::GetPathResult_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xb4931c29424fa01aULL;
  static const uint64_t static_value2 = 0x661c4d9069cdf7e3ULL;
};

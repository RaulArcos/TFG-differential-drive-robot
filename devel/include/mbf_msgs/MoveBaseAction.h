...
struct MD5Sum< ::mbf_msgs::MoveBaseAction_<ContainerAllocator> >
{
  ...
  {
    return "b044be2ca997add2dbbccd9fa0a095b6";
  }

  static const char* value(const ::mbf_msgs::MoveBaseAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb044be2ca997add2ULL;
  static const uint64_t static_value2 = 0xdbbccd9fa0a095b6ULL;
};

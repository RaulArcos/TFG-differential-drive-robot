...
if("TRUE" STREQUAL "TRUE")
  set(robotuca_people_follower_SOURCE_PREFIX /home/robot/robotuca/src/robotuca_people_follower)
  set(robotuca_people_follower_DEVEL_PREFIX /home/robot/robotuca/devel)
  ...
  set(robotuca_people_follower_INSTALL_PREFIX /home/robot/robotuca/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotuca_people_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/robotuca/src/robotuca_people_follower/${idir}'.  ${_report}")
    endif()

...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/pi/rah_ws/src/navigation)
  set(navigation_DEVEL_PREFIX /home/pi/rah_ws/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/pi/rah_ws/install)
...
if(NOT "/home/pi/rah_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'guillegp93 <guillegp93@hotmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/rah_ws/src/navigation/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;message_runtime;std_msgs;geometry_msgs;move_base_msgs;actionlib")
